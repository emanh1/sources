(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("abort-controller"), require("form-data"), require("cheerio")) : typeof define === "function" && define.amd ? define(["exports", "abort-controller", "form-data", "cheerio"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.index = {}, global["abort-controller"], global["form-data"], global.cheerio));
})(this, function(exports2, AbortController, FormData, cheerio) {
  "use strict";
  ...
  async function fetchChapters$3(manga) {
    const url = `${baseUrl$3}manga/${toSnakeCase$2(manga.title)}/`;
  ...
  async function fetchPages$3(chapter) {
  ...
  async function fetchChapters$1(manga) {
    const url = `${baseUrl$1}/manhwa/${toSnakeCase$1(manga.title)}/`;
    const response = await manga.proxiedFetcher(url);
    const $ = cheerio__namespace.load(response);
  ...
  exports2.fetchPagesFromSource = fetchPagesFromSource;
  ...
  exports2.runAllSourcesForChapters = runAllSourcesForChapters;
  exports2.runSourceForChapters = runSourceForChapters;
